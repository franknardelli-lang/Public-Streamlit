...
pt = st.sidebar.number_input("Tx Power (dBm)", value=20.0, step=0.2)
gt = st.sidebar.number_input("Tx Antenna Gain (dBi)", value=2.0, step=0.2)
gr = st.sidebar.number_input("Rx Antenna Gain (dBi)", value=2.0, step=0.2)
ltx = st.sidebar.number_input("Tx Losses (dB)", value=1.0, step=0.2)
lrx = st.sidebar.number_input("Rx Losses (dB)", value=1.0, step=0.2)
loth = st.sidebar.number_input("Other Losses (dB)", value=0.0, step=0.2)
fm = st.sidebar.number_input("Fade Margin (dB)", value=10.0, step=0.2)
sens = st.sidebar.number_input("Rx Sensitivity (dBm)", value=-90.0, step=0.2)
